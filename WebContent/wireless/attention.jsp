    	...
    	<div id="admin">
    		<div class="ad-menu" id="ad-menu">
                ...
                <div class="ad-list">
                    <ul>
                        <li>
                            <div class="li-item"><em class="scm li-ico ic1"></em><a href="index.jsp">首页</a><span class="scm arrow"></span></div>
                        </li>
                        <li>
    		...
    		<div class="ad-comment-box" id="ad-comment">
                ...
                <div class="ad-main-comment J_mainContent" id="ad-iframe">
                    <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="attention1.jsp" frameborder="0"></iframe>
                </div>
    		</div>
    	</div>
